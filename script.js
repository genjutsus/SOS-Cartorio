document.addEventListener('DOMContentLoaded', () => {
    ...
    const resultTemplates = {
        ...
        form2: {
            text: '<strong> RESULTADO  </strong> <br> <br> Excelentíssima Autoridade Policial,<br><br>Informo que, no dia de hoje, entrei em contato através de ligação telefônica com a vítima do crime narrado no procedimento em epígrafe, uma vez que trata-se de crime de Ação Pública Condicionada e no procedimento não consta representação criminal. O objetivo do contato foi apurar se há, em caso de êxito no esforço investigativo-criminal para identificação do autor do fato, possibilidade da vítima oferecer a representação criminal, necessária, nos termos do Artigo 5º, § 4º, do Código de Processo Penal, para a instauração do inquérito policial. Resguardando, também, o princípio da eficiência insculpido no Artigo 37 da Constituição Federal.<br><br>O contato foi feito com a vítima foi feito com êxito através do número {2telefone}, em ligação na qual a mesma se manifestou no sentido da não-possibilidade de oferecimento da referida representação. Nesse sentido, recomendo, salvo melhor juízo, a suspensão do presente procedimento.<br><br>É o que me cabe informar.',
